...
grid on
set(gcf,'color','w');  
figure(23);bar([PcQcTAble_OIDnew.store_Gug_Qg(:,3) PcQcTAble_VAR.store_VAR_Qg(:,3) PcQcTAble_noCont.store_Gug_Qg(:,3)],'DisplayName','PcQcTAble_OID.store_Gug_Pg')
legend({'OID', 'Volt/VAR', 'No Control'})
%%ylim([0 0.05])
xlabel('Time')
ylabel('Reactive Power [kVAR]')
...
set(gcf,'color','w');  
% Active Power
figure(24);bar([PcQcTAble_OIDnew.store_Gug_Pg(:,3) PcQcTAble_VAR.store_VAR_Pg(:,3) PcQcTAble_noCont.store_Gug_Pg(:,3)],'DisplayName','PcQcTAble_OID.store_Gug_Pg')
legend({'OID', 'Volt/VAR', 'No Control'})
%ylim([0 0.05])
xlabel('Time')
