%clear all;
%% 
% load('OID_Voltage.mat');
% load('OID_PQ.mat');
% load('OID_I2R_Drop.mat');
% load('OID_capPen.mat');
% %
% load('VAR_Voltage_day.mat');
% load('VAR_PQ_day.mat');
% load('VAR_I2R_Drop_day.mat');
% load('VAR_capPen_day.mat');
% %
% load('VAR_Voltage.mat');
% load('VAR_PQ.mat');
% load('VAR_I2R_Drop.mat');
% load('VAR_capPen.mat');
%% Penetration graph OID
figure(1);semilogy([Penetration_OIDnew.store_Gug_Penet],Penetration_OIDnew.store_Gug_PVGen)
hold on
...
figure(2);semilogy([Penetration_VARn_noExtraQ.store_VAR_Penet],Penetration_VARnew.store_VAR_noExtraQ)
hold on
semilogy(Penetration_VARnew.store_VARn_noExtraQ,sum(PcQcTAble_VARnew.store_VAR_noExtraQ,1))
legend({'PV_{av}','PV_{c}'}, 'Location', 'northwest')
ylim([1 10^4])
xlabel('Penetration')
ylabel('Active Power [kW]')
...
plot(Penetration_VARnew.store_VAR_Penet,sum(PcQcTAble_VARnew.store_VAR_Pc,1),'g--')
plot(Penetration_VAR_noOverCap.store_VAR_noExtraQ,sum(PcQcTAble_VAR_noExtraQ.store_VAR_Qc,1),'r--')
plot(Penetration_VAR_noOverCap.store_VAR_noExtraQ,sum(PcQcTAble_VAR_noExtraQ.store_VAR_Pc,1),'g--')
...
set(gcf,'color','w'); 
%% Pg 
figure(6);fig61 = plot(1:48, PcQcTAble_OIDnew.store_Gug_Pg(:,6),'r');
hold on
fig62 = plot(1:48, PcQcTAble_VARnew.store_VAR_Pg(:,6),'b--');
...
set(gcf,'color','w'); 
% Qg 
figure(7); fig71 = plot(1:48, PcQcTAble_OIDnew.store_Gug_Qg(:,6), 'r');
hold on
fig72 = plot(1:48, PcQcTAble_VARnew.store_VAR_Qg(:,6), 'b--');
...
%%
%% Pc & Qc
figure(61);fig61 = plot(1:48, PcQcTAble_OIDnew.store_Gug_Pc(:,6),'r');
hold on
fig62 = plot(1:48, PcQcTAble_VARnew.store_VAR_Pc(:,6),'b--');
legend([fig61(1) fig62(1)],'P_g OID','P_g Volt/VAR', 'Location', 'southwest')
%ylim([1 10^4])
xlabel('Time')
ylabel('Active Power P_g [?]')
...
set(gcf,'color','w'); 
% Qg 
figure(71); fig71 = plot(1:48, PcQcTAble_OIDnew.store_Gug_Qc(:,6), 'r');
hold on
fig72 = plot(1:48, PcQcTAble_VARnew.store_VAR_Qc(:,6), 'b--');
legend([fig71(1) fig72(1)],'Q_g OID','Q_g Volt/VAR', 'Location', 'southwest')
%ylim([1 10^4])
xlabel('Time')
ylabel('Reactive Power [?]')
...
set(gcf,'color','w');
%% Grid PF OID
figure(11);fig111 = plot(1:48, abs(PcQcTAble_OIDnew.store_Gug_Pg(:,6)./sqrt(PcQcTAble_OIDnew.store_Gug_Pg(:,6).^2+PcQcTAble_OIDnew.store_Gug_Qg(:,6).^2)));
%hold on
%fig62 = plot(1:48, [PcQcTAble_VARnew.store_VAR_Pg],'b--');
%legend([fig111(2) fig111(6) fig111(13)],'2','6','13', 'Location', 'southwest')
legend(fig111(1),'PF', 'Location', 'southwest')
%ylim([1 10^4])
xlabel('Time')
ylabel('Power factor')
title('Power factor at a distribution transformer with OID')
grid on
set(gcf,'color','w'); 
% Grid PF Volt/VAr
figure(12);fig112 = plot(1:48, abs(PcQcTAble_VARnew.store_VAR_Pg(:,6)./sqrt(PcQcTAble_VARnew.store_VAR_Pg(:,6).^2+PcQcTAble_VARnew.store_VAR_Qg(:,6).^2)));
%hold on
%fig62 = plot(1:48, [PcQcTAble_VARnew.store_VAR_Pg],'b--');
%legend([fig112(2) fig112(6) fig112(13)],'2','6','13', 'Location', 'southwest')
legend(fig112(1),'PF', 'Location', 'southwest')
%ylim([1 10^4])
xlabel('Time')
ylabel('Power factor')
title('Power factor at a distribution transformer with Volt/VAr')
grid on
set(gcf,'color','w'); 
%% ================================
