function [solar, solarInstalled, solarGen, loadHH, loadTotal, timestamp, penetration, nBuses] = dataInput(testCase, solarCap, PVcap)
%% inputs
load('loadData.mat', 'loadData'); load('solarProfile.mat', 'solarHH'); % load input files
...
if nBuses < 25 
    loadtable = loadData(1:48,[2 9:9+nBuses-2]);
